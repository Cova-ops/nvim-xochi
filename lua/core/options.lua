...
vim.opt.guicursor = "i-ci:ver30-1Cursor-blinkwait300-blinkon200-blinkoff150"
...
vim.api.nvim_create_autocmd({ "BufReadPost", "BufNewFile", "FileType" }, {
	callback = function(args)
		-- intenta arrancar treesitter
		local ok = pcall(vim.treesitter.start, args.buf)

		-- si NO pudo arrancar, asegúrate de tener syntax normal
		if not ok then
